...
export const displayCheckListFunc = (projectInstance, checkListInstance, toDoIndex, projectPosition) => {
    ...
    //displays the checklist requires project Instance can get refactored main place
    ...
    displayCheckList();
    //function that creates a modal when editing or creating a checkList based on whether it contains an index or not`
